...
class RagVisionOutput(BaseModel):
    ...
    flag: Optional[Dict[str, float]]= Field(None, description="Boolean decision or classification result generated by the model, if applicable.")
    ...
    @staticmethod
    def fails(imageId, elapsedTimeMs, err):
        """
    ...
    @staticmethod
    def success_output(imageId, elapsedTimeMs, flag, explanation, classScores, rawResponse):
        """
        ...
        Args:
            imageId (str): Identifier of the processed image.
            elapsedTimeMs (int): Processing time in milliseconds.
            flag (bool, str): Model decision or classification output.
